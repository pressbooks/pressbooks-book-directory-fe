<template>
                ...
                <div class="dropdown relative w-full px-5 py-4 border border-gray-300">
                  <div class="dropdown-head flex flex-row items-center justify-between w-full">
                    ...
                    <div class="action">
                      <a href="#!">
                        <img
                          src="src/assets/icons/chev-down.png"
                          width="16"
                          alt=""
                        >
                      </a>
              ...
              <div class="heading px-5 py-3 bg-gray-200">
                <div class="flex flex-row items-center justify-between">
                  ...
                  <div class="action">
                    <a href="#!">
                      <img
                        src="src/assets/icons/chev-up.png"
                        width="16"
                        alt=""
                      >
                    </a>
          ...
          <div class="tags flex flex-row flex-wrap">
            <div class="tag flex flex-row items-center bg-gray-200 px-3 py-3 rounded-full mr-2 mb-2">
              ...
              <div>
                ...
                >
                  <img
                    src="src/assets/icons/times.png"
                    width="14"
                    alt=""
                  >
                </a>
  ...
  <footer>
    <div class="container mx-auto py-12 px-8">
      <div class="top">
        <img
          src="src/assets/logo-simple.png"
          width="170"
          alt="Logo"
        >
      </div>
        ...
        <div class="right">
          <div class="icons flex flex-row">
            ...
            <div class="icon px-2">
              ...
              >
                <img
                  src="src/assets/icons/social-in.svg"
                  width="19"
                  alt="Logo"
                >
              </a>
            ...
            <div class="icon px-2">
              ...
              >
                <img
                  src="src/assets/icons/social-youtube.svg"
                  width="20"
                  alt="Logo"
                >
              </a>
