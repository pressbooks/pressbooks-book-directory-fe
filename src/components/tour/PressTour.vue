...
const waitToShowFirstFilter = 250;
const indexToStartFilters = 10;
const h5pLogoWidth = 100;
...
export default {
  ...
  mounted() {
    ...
    const firstFilter = document.querySelector('#filters .v-list-item');
    ...
    setTimeout(()=>{
      ...
      this.intro = introJS()
        .setOptions({
          ...
          <p>Clicking the blue checkmark will filter results so that books with this attribute are included in the results.</p>
           `,
              element: document.querySelector('#filters .v-list-item__action button:first-child'),
              position: 'right'
            },
            {
          ...
          <p>Clicking the red X will filter results so that books with this attribute are excluded from the results.</p>
           `,
              element: document.querySelector('#filters .v-list-item__action button:last-child'),
              position: 'right'
            },
            {
          ...
          <p>This icon indicates the copyright license for the work (all rights reserved or one of the creative commons licenses). Hovering over the icon will display the license name.</p>
           `,
            ...
            },
            {
              ...
              intro: `
          <img src="${this.h5pActivitiesImage}" alt="H5P Logo" width="${h5pLogoWidth}" />
      ...
      this.intro.onafterchange((targetElement) => {
        ...
        } else if (targetElement.classList.contains('v-btn') && this.stepIndex === indexToStartFilters) {

          //Open next filter to help understand multiple filters explanation
          firstFilter.parentElement.nextElementSibling.firstChild.click();
