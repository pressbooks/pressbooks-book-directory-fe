module.exports = {
    'Filter wordCount (between 1300 and 3100 words) from URL': function (browser) {
        browser
    ...
    'Filtering by subject from an URL': function (browser) {
        browser
    ...
    'Filtering by publisher from an URL': function (browser) {
        browser
            .url(process.env.HOST_TEST)
            .waitForElementVisible('body')
            .waitForElementVisible('.ais-Hits__books-book')
